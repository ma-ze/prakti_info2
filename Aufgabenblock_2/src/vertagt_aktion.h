...
namespace vertagt
{
	...
	public:
		VAktion() : p_pListe(*(new std::list<T>())) {} // Default constructor
	...
	public:
		VPushBack() : VAktion<T>(*(new std::list<T>())), p_objekt() {} // Default constructor
	...
	public:
		VPushFront() : VAktion<T>(*(new std::list<T>())), p_objekt() {} // Default constructor
	...
	public:
		VErase() : VAktion<T>(*(new std::list<T>())), p_it() {} // Default constructor
