...
void Fahrzeug::vKopf(){
    ...
    << "ID" << std::setw(20) << "Name" << std::setw(20) << "MaxGeschwindigkeit" << std::setw(15) << "GesamtStrecke" << std::setw(15) << "GesamtZeit" << std::setw(15) << "Zeit" << std::endl;
    std::cout << "-------------------------------------------------------------------------------------------";
}
void Fahrzeug::vSimulieren(){
    if(p_dZeit != dGlobaleZeit){
        double elapsedTime = dGlobaleZeit - p_dZeit;
        p_dGesamtStrecke += p_dMaxGeschwindigkeit * elapsedTime;
